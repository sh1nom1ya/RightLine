...
const services = [
    {
        ...
        important: "Это важное сообщение для эквайринговых клиентов. Это важное сообщение для эквайринговых клиентов. ",
        image: cardphoto,
    },
    {
        title: "E-commerce",
...
const HomePage = () => {
    ...
    return (
        <>
            ...
            <Modal isOpen={!!selectedCard} onClose={() => setSelectedCard(null)} width="1000px" height="800px">
